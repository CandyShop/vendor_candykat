...
PRODUCT_VERSION_MAINTENANCE = v1.5.4
...
# Set all versions
CANDYKAT_VERSION := Ck-$(PRODUCT_VERSION_MAINTENANCE)-$(CANDYKAT_BUILD_TYPE)$(CANDYKAT_POSTFIX)
CANDYKAT_MOD_VERSION := CandyKat-$(PRODUCT_VERSION_MAINTENANCE)-$(CANDYKAT_BUILD_TYPE)-$(PRODUCT_VERSION_MINOR)-$(CANDYKAT_POSTFIX)
